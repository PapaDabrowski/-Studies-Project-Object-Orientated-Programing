...
void App_Singleton::Create(unsigned int X)
{
  ...
  cout<<"Choose 3 to Create Handgun:"<<endl;
	cout<<"Choose 4 to Create Personal Defence Weapon"<<endl;
	cout<<"Choose 5 to Create Light Machine Gun"<<endl;
	cout<<"Choose 6 to Create Designated Marksman Rifle"<<endl;
  cout<<"Type number: ";
  try{
	 cin>>select;
	 if(cin.fail())
    ...
    switch(select)
    {
     ...
     case 1:
     {
        cout<<"Enter the Caliber of your Weapon"<<endl<<"Type number: ";
				...
				if(Caliber_<=0) throw WrongValue(1);
       ...
       Case.AddElement(Object);
	     ...
	     cout<<endl<<"Object has been created!"<<endl<<endl;
			...
			case 4:
			{
			 ...
			 if(cin.fail()) throw WrongValue(8);
			 if((Silencer_!=0) && (Silencer_!=1)) throw WrongValue(8);
			 Weapon *Object=new PDW(X,Caliber_,
	     ...
	     cout<<endl<<"Object has been created!"<<endl<<endl;
		  ...
		  case 5:
		  {
  			...
  			if(Weight_==0) throw WrongValue(5);
				...
				if(cin.fail()) throw WrongValue(6);
				if(Rate_==0) throw WrongValue(6);
				Weapon *Object=new LMG(X,Caliber_,MagSize_,MuzzleVelocity_,
				Range_,Weight_,Rate_);
				Case.AddElement(Object);
				system("clear");
		    cout<<endl<<"Object has been created!"<<endl<<endl;
		   ...
		   case 6:
		   {
   			 ...
   			 if(Weight_==0) throw WrongValue(5);
				 ...
				 if(cin.fail()) throw WrongValue(7);
				 if((Scope_%2!=0)||(Scope_==0)) throw WrongValue(7);
      	 Weapon *Object=new DMR(X,Caliber_,
		  ...
		  if(temp1=="LMG")
			{
				...
				Weapon *Object=new LMG(Id_,Caliber_,
				MagSize_,MuzzleVelocity_,Range_,Weight_,Rate_);
				Case.AddElement(Object);
			}
			if(temp1=="PDW")
			{
				...
				getline(FILE,temp);
				Silencer_=atoi(temp.c_str());
				Weapon *Object=new PDW(Id_,Caliber_,
				MagSize_,MuzzleVelocity_,Range_,Weight_,Rate_,Silencer_);
				Case.AddElement(Object);
			}
			if(temp1=="DMR")
			{
				...
				getline(FILE,temp);
				Scope_=atoi(temp.c_str());
				Weapon *Object=new DMR(Id_,Caliber_,
				MagSize_,MuzzleVelocity_,Range_,Weight_,Rate_,Scope_);
				Case.AddElement(Object);
			}
		}
